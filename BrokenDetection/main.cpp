 ...
 * Author: xindong
 *
 * Created on September 23, 2014, 11:01 PM
 */


// 运行程序，点击两个点生成直线，然后按‘d’沿这个直线检测崩损，按‘r’擦除检测崩损（同一张图上可以画多条直线检测）
    ...
    do{  
        ...
        case 'd':
            if (pts.size() == 2)
            {
                ...
                BrokenAreaDetectionNew(img_edge, lines, broken_position, dual_position, crack_position, win_size);
